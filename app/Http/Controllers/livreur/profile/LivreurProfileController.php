...
namespace App\Http\Controllers\livreur\profile;
...
class LivreurProfileController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        //dd($user->profile);
        return view('livreurs.profiles.index', compact('user'));
    }
    ...
    {
                //dd(Auth::user()->livreur->first_name);
          if(Auth::user()->livreur){
            ...
            $mailInscripton = [
                ...
                'first_name_of_users' => $user->livreur->first_name,
                    'last_name_of_users'  => $user->livreur->last_name,
                ...
                if(isset($user->livreur)){
                    //dd($request->all(),$new_password, $mailInscripton);
    
                    $log = array(
                        'subject' => "Modification des infos de connexion de "." ".$user->livreur->first_name." ".$user->livreur->last_name,
                        'url' => $request->fullUrl(),
    ...
    public function update(Request $request, string $id)
    {
        ...
        if(isset($user->livreur)){
            $profile = $user->livreur()->update($tab_profile);
        }else{
            $profile = $user->livreur()->create($tab_profile);
        }
       ...
       return to_route('profile.livreur.index');
    }
