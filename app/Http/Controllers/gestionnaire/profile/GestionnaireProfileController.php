...
namespace App\Http\Controllers\gestionnaire\profile;
...
class GestionnaireProfileController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        //dd($user->profile);
        return view('gestionnaires.profiles.index', compact('user'));
    }
    ...
    public function update(Request $request, string $id)
    {
       ...
       return to_route('profile.gestionnaire.index');
    }
