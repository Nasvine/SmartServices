...
class RestaurantController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.restaurants.create', compact('category_plats'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('restaurant.admin.index');
    }
    ...
    public function show($id)
    {
        ...
        #dd($id, $restaurant);
        //dd($user->profile);
        return view('admin.restaurants.show', compact('restaurant', 'category_plats'));
    }
    ...
    public function edit(string $id)
    {
        $restaurant = Restaurant::find($id);
        $category_plats = Category_plat::all();
        return view('admin.restaurants.edit', compact('category_plats', 'restaurant'));
    }
