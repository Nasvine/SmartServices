                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <a href="{{ route('boutique.admin.create') }}" class="btn " type="button" style="background-color: #fe9003; color: #ffffff" >Créer une boutique</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('boutique.admin.edit', $boutique->id) }}" class="btn text-primary" {{-- data-bs-toggle="modal" data-bs-target=".editboutique_{{ $boutique->id }}" --}}><i class="icon-pencil" style="font-size: 20px;"></i></a>
