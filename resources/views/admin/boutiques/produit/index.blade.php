                    ...
                    <div class="table-responsive product-table">
                        ...
                        <tbody>
                            @foreach ($produits as $produit)
                                <tr>
                                    <td class="text-center"><img src="{{ asset('boutiques/produits/images/'.$produit->lienPhoto) }}" {{-- style="width: 20%; height:20%;" --}} width="90px" height="90px"  alt=""></td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" type="text" name="description" id="" cols="5" rows="3">{{ $produit->description }}</textarea>  
                                                                    @error('description')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
