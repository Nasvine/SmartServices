                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <a href="{{ route('restaurant.admin.create') }}" class="btn " type="button" style="background-color: #fe9003; color: #ffffff" >Créer une restaurant</a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('restaurant.admin.edit', $restaurant->id) }}" class="btn text-primary"><i class="icon-pencil" style="font-size: 20px;"></i></a>
                                        <a href="{{ route('restaurant.admin.show', $restaurant->id) }}" class="btn text-dark"><i class="icon-eye" style="font-size: 20px;"></i></a>
                                        
                                        <form class="px-1 bg-red-500 hover:bg-red-700 text-white rounded-md" method="POST" action="{{ route('restaurant.admin.destroy', $restaurant->id) }}">
                                            @csrf
                                            @method('DELETE')
          ...
          <div class="card-body btn-showcase">
            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('restaurant.admin.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-4">
