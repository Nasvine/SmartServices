                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <a href="{{ route('restaurant.admin.index') }}" class="btn " type="button" style="background-color: #fe9003; color: #ffffff"><i class="icofont icofont-arrow-left"></i> <span class="ms-2">Retour</span></a >
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('restaurant.admin.update', $restaurant->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="validationCustom01">Selectionner le(s) catégories de plats</label>
                                                <select class="form-select js-example-placeholder-multiple col-sm-6" name="category_plats[]" id="validationCustom01" data-placeholder="Selectionner le(s) catégories de plats" multiple="multiple">
                                                    @foreach ($category_plats as $k => $category_plat)
                                                        <option value="{{ $category_plat->id }}" {{ $restaurant->category_plats->contains($category_plat) ? 'selected' : '' }}>{{ $k + 1 }} - {{ $category_plat->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" type="text" name="description" cols="3" rows="5">{{ $restaurant->description }}</textarea> 
                                                @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
