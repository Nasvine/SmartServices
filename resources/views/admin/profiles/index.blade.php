    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 col-lg-6 col-xl-4 box-col-6">
          <div class="card custom-card p-0">
            ...
            <div class="card-profile"><img class="rounded-circle" src=" {{ asset('utilisateurs/images/image_profile/'.$user->profile->photo) ?? "../assets/images/avtar/16.jpg" }}" alt=""></div>
      ...
      <div class="col-sm-6 col-md-6  col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
                <form class="needs-validation" action="{{ route('profile.admin.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @if (session('status'))
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" action="{{ route('profile.admin.update', $user->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
