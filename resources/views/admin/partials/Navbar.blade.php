<div class="header-wrapper row m-0">
  ...
  <div class="nav-right col-8 pull-right right-header p-0">
    <ul class="nav-menus">
     ...
     {{--  <li><span class="header-search"><i data-feather="search"></i></span>
      </li> --}}
      {{-- <li class="onhover-dropdown">
        ...
        <ul class="notification-dropdown onhover-show-div">
          ...
          <li><a class="btn " style="background-color: #fe9003; color: #ffffff" href="#">Check all notification</a></li>
        </ul>
      </li> --}}
      {{-- <li class="onhover-dropdown">
      ...
      <li class="profile-nav onhover-dropdown p-0 me-0">
        ...
        <ul class="profile-dropdown onhover-show-div" style="width: 170px">
          <li><a href="{{-- {{ route('profile.admin.index') }} --}}"><i data-feather="user"></i><span>Profile </span></a></li>
