              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    ...
                    <img src="{{ asset('Images_Smart/logo smart service.jpg') }}" height="100px" width="100px" alt="">
                  </span>
                  <span class="app-brand-text demo text-body fw-bold">Smart Services</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Reinitialisation du mot de Passe</h4>
              <p class="mb-4">Veuillez entrer vos données</p>

             
              <form id="formAuthentication" method="POST" action="{{ route('password.store') }}" class="mb-3">
                @csrf
                <div class="mb-3">
                <input type="hidden" name="token" value="{{ $request->route('token') }}">
                ...
                <div class="mb-3">
                  <button class="btn d-grid w-100" style="background-color: #235d8a; color:#ffff" type="submit">Reinitialiser</button>
                </div>
              </form>
