<div>
  <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{ asset('images/logo_1.jpg')}}" alt=""><img class="img-fluid for-dark" src="{{ asset('assets/images/logo/logo_dark.png')}}" alt=""></a>
  ...
  <nav class="sidebar-main">
    ...
    <div id="sidebar-menu">
      <ul class="sidebar-links" id="simple-bar">
        ...
        {{-- <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('boutique.list.client.index') }}"><i data-feather="shopping-cart"></i><span>Boutiques</span></a></li>
        
        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('restaurant.list.client.index') }}"><i data-feather="box"></i><span>Restaurants</span></a></li> --}}
        ...
        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('boutique_client.client.index') }}"><i data-feather="box"></i><span>Créer une Boutique</span></a></li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('restaurant_client.client.index') }}"><i data-feather="box"></i><span>Créer un restaurant</span></a></li>
 ...
 {{--       <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="layout"></i><span class="lan-7">Page layout</span></a>
       ...
       <li class="mega-menu"><a class="sidebar-link sidebar-title" href="#"><i data-feather="layers"></i><span>Others</span></a>
        ...
        --}}
        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="support-ticket.html"><span></span></a></li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="support-ticket.html"><span></span></a></li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="support-ticket.html"><span></span></a></li>
