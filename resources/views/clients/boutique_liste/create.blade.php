            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6">
                            <h5>Créaction d'une boutique</h5>
                        </div>
                        <div class="col-lg-6 text-end">
                            <a href="{{ route('boutique_client.client.index') }}" class="btn " type="button" style="background-color: #fe9003; color: #ffffff"><i class="icofont icofont-arrow-left"></i> <span class="ms-2">Retour</span></a >
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="modal-title" id="myLargeModalLabel">Formulaire de création d'une boutique</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('boutique_client.client.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="recipient-name" type="text" name="nom_boutique" value="{{ old('nom_boutique') }}" placeholder="Entrer le nom de la boutique">
                                                    @error('name')
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="recipient-name" type="text" name="adresse_boutique" value="{{ old('adresse_boutique') }}" placeholder="Entrer l'adresse de la boutique">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="recipient-name" type="text" name="ville" value="{{ old('ville') }}" placeholder="Entrer la ville de la boutique">
                                                    @error('ville')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="recipient-name" type="text" name="telephone" value="{{ old('telephone') }}" placeholder="Entrer le numéro de la boutique">
                                                    @error('telephone')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="recipient-name" type="email" name="email" value="{{ old('email') }}" placeholder="Entrer l'email de la boutique">
                                                    @error('email')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select js-example-placeholder-multiple col-sm-6" name="category_produits[]" id="validationCustom01" data-placeholder="Selectionner le(s) permissions" multiple="multiple">
                                                        @foreach ($category_produits as $k => $category_produit)
                                                            <option value="{{ $category_produit->id }}">{{ $k + 1 }} - {{ $category_produit->name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" type="text" name="description" id="" value="{{ old('description') }}" cols="5" rows="3"></textarea>  
                                                    @error('description')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="{{ route('boutique_client.client.show', $boutique->id) }}" class="btn text-dark"><i class="icon-eye" style="font-size: 20px;"></i></a>
                                        
                                        <form class="px-1 bg-red-500 hover:bg-red-700 text-white rounded-md" method="POST" action="{{ route('boutique_client.client.destroy', $boutique->id) }}">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <div class="modal fade editboutique_{{ $boutique->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        ...
                                        <form action="{{ route('boutique_client.client.update', $boutique->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
