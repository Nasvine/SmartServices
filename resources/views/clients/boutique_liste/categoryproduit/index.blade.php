                        ...
                        <tbody>
                            @foreach ($category_produits as $k => $category_produit )
                                <tr>
                                    ...
                                    <div class="btn-group">
                                        <a class="m-2" data-bs-toggle="modal" data-bs-target=".editcategory_produit_{{ $category_produit->id }}"><i class="icon-pencil" style="font-size: 20px;"></i></a>
