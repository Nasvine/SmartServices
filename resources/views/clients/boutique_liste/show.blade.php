    ...
    <div class="container-fluid">
      <div class="page-title">
        <div class="row">
          ...
          <div class="col-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('boutique_client.client.index') }}"><i data-feather="home"></i></a></li>
          ...
          <div class="card">
            <div class="product-box">
              ...
              <div class="product-details">
                ...
                <h4 class="text-center">{{ $boutique->nom_boutique }}</h4>
                <a class="btn btn-primary mt-2 ms-5" href="{{ route('statistique.boutique.client.index_boutique', $boutique->id) }}">Voir Statistiques</a>
