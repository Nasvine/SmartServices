            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                          <div class="col-md-10">
                            <h6>Liste des ventes dans le restaurant <span class="text-success">{{ $restaurant->nom_restaurant }}</span></h6>
                          </div>
                          <div class="col-md-2">
                            {{-- <div class="btn-group">
                              <form action="">
                            ...
                            <a href="{{ route('restaurant_client.client.show', $restaurant->id) }}" class="btn btn-primary ms-2 rounded-2">Retour</a>
                          </div>
                        </div>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                          <thead>
                            ...
                            <th class="text-center" scope="col"><b>Plats</b></th>
