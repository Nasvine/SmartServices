    ...
    <div class="container-fluid">
          ...
          <div class="card custom-card p-0">
            <div class="card-header"><img class="img-fluid" src="{{ asset('simpe_image.jpg') }}" alt=""></div>
                @if (isset($user->profile))
                    <div class="card-profile"><img class="rounded-circle" src=" {{ asset('utilisateurs/images/image_profile/'.$user->profile->photo) }}" alt=""></div>
                @else
      ...
      <div class="col-sm-6 col-md-6  col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
                <form class="needs-validation" action="{{ route('profile.client.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @if (session('status'))
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" action="{{ route('profile.client.update', $user->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
