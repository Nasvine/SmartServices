...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('new/css/responsive.css') }}">
	<!-- color -->
  <link rel="stylesheet" href="{{ asset('new/css/color.css') }}">
					...
					<div class="header-style">
						<a href="index.html">
                            ...
                            <div>
                                ...
                                <img src="{{ asset('Images_Smart/logo_smart_service.jpg') }}" width="60px;" height="60px;"  alt=""> <span style="font-size: 20px;">Smart Services</span> 
                            </div>
						</a>
