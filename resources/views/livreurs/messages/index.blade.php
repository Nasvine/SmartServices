        ...
        <div class="row">
          ...
          <div class="col-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ route('messages.livreur.index') }}">Message</a></li>
                          ...
                          <div class="prooduct-details-box">                                 
                            <div class="media"><img class="align-self-center img-fluid img-60" src="{{asset('utilisateurs/images/image_profile/'.User::Find($message->user_id)->profile->photo )}}" alt="#">
                              <div class="media-body ms-3">
                                ...
                                <a class="btn btn-primary btn-xs" href="#">{{ $message->created_at }}</a><a href="{{ route('messages.livreur.delete_message', $message->id) }}" {{-- target="_blank" --}} rel="noopener noreferrer"><i class="close" data-feather="x"></i></a>
                              </div>
                            </div>
                          </div>
                        </div>
