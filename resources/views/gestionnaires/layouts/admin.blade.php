...
<html lang="en">
  ...
  <body>
    @include('gestionnaires.partials.toastr')
    <!-- tap on top starts-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper">
          @include('gestionnaires.partials.Sidebar')

          @include('gestionnaires.partials.flash-message')
        ...
        <!-- footer start-->
        <footer class="footer">
          @include('gestionnaires.partials.Footer')
        </footer>
