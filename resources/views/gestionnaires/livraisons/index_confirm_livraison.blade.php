      ...
      <div class="row">
        <div class="col-sm-12 col-xl-6 xl-100">
            <div class="card">
              ...
              <div class="card-body">
                <form class="needs-validation" action="{{ route('livraison.gestionnaire.confirme_livraison', $livraison->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="row mt-3">
                        <div class="col-md-6">
                          <label class="form-label" for="validationCustom01">Modifier le prix de la livraison</label>
                          <input class="form-control" id="validationCustom01" type="number" name="prix" value="{{ $livraison->prix }}">
                          @error('prix')
