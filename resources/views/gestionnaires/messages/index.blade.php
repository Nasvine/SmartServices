        ...
        <div class="row">
          ...
          <div class="col-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ route('messages.gestionnaire.index') }}">Message</a></li>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  @foreach ($messages as $message)
                    <div class="card-body">
                      <div class="row">
                        <div class="col-xxl-4 col-md-12" style="background-color: rgb(230, 230, 230)">
                          <div class="prooduct-details-box">                                 
                            <div class="media"><img class="align-self-center img-fluid img-60" src="{{asset('utilisateurs/images/image_profile/'.User::Find($message->user_id)->profile->photo )}}" alt="#">
                              <div class="media-body ms-3">
                                ...
                                <a class="btn btn-primary btn-xs" href="#">{{ $message->created_at }}</a><a href="{{ route('messages.gestionnaire.delete_message', $message->id) }}" {{-- target="_blank" --}} rel="noopener noreferrer"><i class="close" data-feather="x"></i></a>
                              </div>
                            </div>
                          </div>
                        </div>
