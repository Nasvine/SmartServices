                ...
                <div class="card-header card-no-border">
                  ...
                  <div class="media">
                    <div class="media-body">
                      <p><span class="f-w-500 font-roboto" style="font-size: 20px">Nombre total de course effectuée aujourd'hui.</span><span class="f-w-700 font-primary ms-2"></span></p>
            ...
            <div class="col-xl-6 box-col-6 col-md-6">
              <div class="card o-hidden">
                <div class="card-header card-no-border">
                  ...
                  <div class="media">
                    <div class="media-body">
                      <p><span class="f-w-500 font-roboto" style="font-size: 20px">Nombre total de course dans le mois.</span><span class="f-w-700 font-primary ms-2"></span></p>
              ...
              <div class="card o-hidden">
                <div class="card-body">
                  <div class="ecommerce-widgets media">
                    <div class="media-body">
                      <p><span class="f-w-500 font-roboto" style="font-size: 20px">Nombre total de livraison dans une boutique.</span><span class="f-w-700 font-primary ms-2"></span></p>
            ...
            <div class="col-xl-6 box-col-6 col-lg-12 col-md-6">
              <div class="card o-hidden">
                <div class="card-body">
                  <div class="media">
                    <div class="media-body">
                      <p class="f-w-500 font-roboto" style="font-size: 20px">Nombre total de clients demandant des course dans le mois<span class="badge pill-badge-primary ms-3"></span></p>
