@php
  ...
  $notifications = Notification::OrderBy('id', 'desc')->where('status', 'non lu')->where('type_d_acteur', 'Gestionnaire')->limit(5)->get();
    ...
    <ul class="nav-menus">
      ...
      <li class="onhover-dropdown notifications_dropdown">
        ...
        <ul class="notification-dropdown onhover-show-div" style="width: 500px;">
          ...
          <livewire:MessageComponent />
          
          <li><a class="btn " style="background-color: #fe9003; color: #ffffff" style="margin-top: 20px;" href="{{ route('messages.gestionnaire.index') }}">Voir tous les messages</a></li>
        </ul>
      </li>
      ...
      <li class="profile-nav onhover-dropdown p-0 me-0">
        ...
        <ul class="profile-dropdown onhover-show-div" style="width: 170px">
          <li><a href="{{ route('profile.gestionnaire.index') }}"><i data-feather="user"></i><span>Profile </span></a></li>
